...
var fl2a1=0,fl2b2=0,fl2time1=null;
...
// var nr=document.getElementById('xin');
// var as=nr.getElementsByTagName('a');
// // alert(as.length);
// for (var i = 0; i < as.length; i++) {
// 	as[i].onmouseover=function (){
// 		for (var i = 0; i < as.length; i++) {
// 			if (as[i]==this) {
// 				as[i].style.border='2px solid #F2689F';
// 			} else{
// 				as[i].style.border='2px solid #E6E6E6';
// 			};
// 		};
// 	}
